...
Para determinar o máximo comprimento que um trem pode trafegar, é necessário analisar o **trecho mais crítico**, a rampa mais íngreme. Assim, dimensionando o número de locomotivas e vagões para este cenário, todos os demais trechos da via serão atendidos.
