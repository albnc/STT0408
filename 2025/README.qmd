...
É importante observar que o gráfico apresenta valores para qualquer extremidade, e sabemos que os motores tem limitações, a saber:
...
Dessa forma, a função anterior fica limita a esses dois limites. Como exemplo, considere a velociade máxima de 90 km/h e a força tratora máxima pela corrente elétrica, limitada pela **Velocidade Mínima de Operação Constante** (VMOC) de 20 km/h.
...
Para que a locomotiva não patine, a **Força Tratora** nas rodas deve ser menor que a **Força de aderência** entre o trilho e as rodas: $F_{t} \leq F_{a}$.

Portanto a **Força Motriz Máxima** está limitada a aderência na interface roda-trilho:
...
Como exemplo, considere uma locomotiva com Peso Bruto Total de 100 toneladas e um fator de aderência $f$ de 0,20, portanto:
